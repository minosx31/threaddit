...
export const Icons = {
    ...
    logo: (props: LucideProps) => (
        ...
        // <svg {...props} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect width="48" height="48" fill="white" fill-opacity="0.01"></rect> <path d="M44 8H4V38H19L24 43L29 38H44V8Z" fill="#2F88FF" stroke="#000000" stroke-width="1.488" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M21 15L20 32" stroke="white" stroke-width="1.488" stroke-linecap="round"></path> <path d="M28 15L27 32" stroke="white" stroke-width="1.488" stroke-linecap="round"></path> <path d="M33 20L16 20" stroke="white" stroke-width="1.488" stroke-linecap="round"></path> <path d="M32 27L15 27" stroke="white" stroke-width="1.488" stroke-linecap="round"></path> </g></svg>
    ),
